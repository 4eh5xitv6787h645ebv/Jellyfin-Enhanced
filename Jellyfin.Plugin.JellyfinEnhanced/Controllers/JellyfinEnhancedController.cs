...
namespace Jellyfin.Plugin.JellyfinEnhanced.Controllers
{
    ...
    public class JellyfinEnhancedController : ControllerBase
    {
        ...
        private static (bool Active, DateTime CachedAt)? _seerrStatusCache;
        private static readonly object _seerrStatusCacheLock = new();
        private static readonly TimeSpan _seerrStatusCacheTtl = TimeSpan.FromSeconds(30);
        ...
        public ActionResult GetPublicConfig()
        {
            ...
            return new JsonResult(new
            {
                ...
                // Per-tag "show on" scope admin defaults (#561) — the client resolves
                // user override → these → true (js/enhanced/tag-visibility.js effective()).
                config.QualityTagsScopeMovies,
                config.QualityTagsScopeShows,
                config.QualityTagsScopeEpisodes,
                config.QualityTagsScopeContinueWatching,
                config.QualityTagsScopeNextUp,
                config.GenreTagsScopeMovies,
                config.GenreTagsScopeShows,
                config.GenreTagsScopeEpisodes,
                config.GenreTagsScopeContinueWatching,
                config.GenreTagsScopeNextUp,
                config.LanguageTagsScopeMovies,
                config.LanguageTagsScopeShows,
                config.LanguageTagsScopeEpisodes,
                config.LanguageTagsScopeContinueWatching,
                config.LanguageTagsScopeNextUp,
                config.RatingTagsScopeMovies,
                config.RatingTagsScopeShows,
                config.RatingTagsScopeEpisodes,
                config.RatingTagsScopeContinueWatching,
                config.RatingTagsScopeNextUp,
                // Rating source admin defaults (#561)
                config.RatingTagsSourceTmdb,
                config.RatingTagsSourceRottenTomatoes,
                config.RatingTagsSourceUserRating,
