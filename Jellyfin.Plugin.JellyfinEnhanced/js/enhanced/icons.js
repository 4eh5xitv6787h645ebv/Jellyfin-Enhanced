(function (JE) {
    ...
    const LUCIDE = {
        ...
        blurOn: '<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="12" r="1"/><circle cx="12" cy="6" r="1"/><circle cx="12" cy="18" r="1"/><circle cx="18" cy="12" r="1"/><circle cx="12" cy="12" r="3"/></svg>',
    ...
    const MUI = {
        ...
        blurOn: '<span class="material-icons" style="font-size:1em;vertical-align:middle;">blur_on</span>',
