...
(function (JE) {
  ...
  // The legacy standalone bookmarks page (its own #/bookmarks route, sidebar
  // injection, view-show/click handlers) has been replaced by the JE web
  // subsystem (js/web/route-hijacker, sidebar-manager, tabs-manager). The
  // module's only remaining responsibility is renderBookmarksLibrary; its
  // public surface is JE.bookmarksLibrary.renderForCustomTab.
