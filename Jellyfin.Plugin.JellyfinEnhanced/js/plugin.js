    ...
    async function initialize() {
        ...
        try {
            ...
            const allComponentScripts = [
                ...
                'enhanced/item-details/features-details-media-info.js',
                'enhanced/item-details/features-release-dates.js',
                'enhanced/item-details/features-details-page.js',
                'enhanced/home-removal/features-remove-home.js',
                'enhanced/home-removal/features-remove-multiselect.js',
                'enhanced/events.js',
                ...
                'enhanced/hidden-content/hidden-content-data.js',
                'enhanced/hidden-content/hidden-content-save.js',
                'enhanced/hidden-content/hidden-content-styles.js',
                'enhanced/hidden-content/hidden-content-dialogs.js',
                'enhanced/hidden-content/hidden-content-panel.js',
                'enhanced/hidden-content/hidden-content-filter.js',
                'enhanced/hidden-content/hidden-content-buttons.js',
                'enhanced/hidden-content/hidden-content-init.js',
                ...
                'enhanced/hidden-content/hidden-content-page-state.js',
                'enhanced/hidden-content/hidden-content-page-styles.js',
                'enhanced/hidden-content/hidden-content-page-admin.js',
                'enhanced/hidden-content/hidden-content-page-cards.js',
                'enhanced/hidden-content/hidden-content-page-render.js',
                'enhanced/hidden-content/hidden-content-page-nav.js',
                'enhanced/hidden-content/hidden-content-page-init.js',
                'enhanced/hidden-content/hidden-content-custom-tab.js',
                ...
                'enhanced/settings-panel/ui-entry-points.js',
                'enhanced/settings-panel/ui-release-notes.js',
                'enhanced/settings-panel/ui-panel-template.js',
                'enhanced/settings-panel/ui-panel-shortcut-editor.js',
                'enhanced/settings-panel/ui-panel-settings.js',
                'enhanced/settings-panel/ui-panel-hidden-content.js',
                'enhanced/settings-panel/ui-panel-language.js',
                'enhanced/settings-panel/ui-panel.js',
                ...
                'jellyseerr/modal.js',
                'jellyseerr/more-info/more-info-modal-styles.js',
                'jellyseerr/more-info/more-info-modal-data.js',
                'jellyseerr/more-info/more-info-modal-seasons.js',
                'jellyseerr/more-info/more-info-modal-badges.js',
                'jellyseerr/more-info/more-info-modal-render.js',
