...
(function() {
    ...
    const ICON_MAP = [
        ...
        { parts: ["has started playing", "on"], icon: "play_arrow", color: "#2196f3" },
        { parts: ["is playing", "on"], icon: "play_arrow", color: "#2196f3" },
        { parts: ["has started playing"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["ha començat a reproduir"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["odtwarza"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["hat die Wiedergabe von", "gestartet"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["est en train de lire"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["está reproduciendo"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["ha avviato la riproduzione di"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["を再生しています"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["- воспроизведение «"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["está reproduzindo"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["speelt", "af"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["재생 중"], icon: "play_arrow", color: "#2196f3" },
        ...
        { parts: ["spelar"], icon: "play_arrow", color: "#2196f3" },
